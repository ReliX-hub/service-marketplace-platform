...
public class JwtService {
    ...
    public String generateAccessToken(User user) {
        ...
        return Jwts.builder()
                ...
                .claim("capabilities", user.getCapabilityTypes().stream()
    ...
    public List<String> extractCapabilities(String token) {
        Object value = extractAllClaims(token).get("capabilities");
        if (!(value instanceof Collection<?> capabilities)) {
            return List.of();
        }
