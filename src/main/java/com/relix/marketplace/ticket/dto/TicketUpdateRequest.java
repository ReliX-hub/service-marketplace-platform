...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Patch-like ticket update; omitted fields keep their current values")
public class TicketUpdateRequest {
    ...
    @Size(max = 200)
    @Schema(example = "Help moving a sofa and two chairs", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    ...
    @Schema(example = "USD", pattern = "[A-Z]{3}", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    ...
    @Builder.Default
    @Schema(description = "Clear both service-window bounds; cannot be combined with serviceWindowStart or serviceWindowEnd",
            example = "false", defaultValue = "false", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    private Boolean clearServiceWindow = false;
    ...
    @Builder.Default
    @Schema(description = "Clear the application deadline; cannot be combined with expiresAt",
            example = "false", defaultValue = "false", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
